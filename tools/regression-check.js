/* 회귀 점검 — 손댈 때마다 이걸 돌린다.
   ...
   기대값 (2026-08-28 기준)
     ...
     핀합계 38           5일치 핀 낼 정차지 합계(좌표가 있고 nopin 이 아닌 것). 숙소 도착·카페 감저·식사 3곳이 들어오고
                         제주현대미술관이 빠졌다.
                         숙소 출발·도착에 숙소 좌표가 들어와 다섯이 늘고, 펜션 조식은 nopin 이라 빠졌다. 1·5일차 점심(진도)에는 좌표를 넣지 않는다 —
                         넣으면 경로선이 완도로 돌아간다(§17 참조)
     ...
     배율 {미술관 14, 일출봉 13, 숲길 12, 맛집 14, 일정_일출봉 13}
                         ...
                         **성산일출봉은 이제 일정에 없다**(주차만 하고 광치기해변까지 걷는다) —
                         일정_일출봉 검사는 못 돈다. 여행지 탭의 배율만 본다
